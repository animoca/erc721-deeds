...
import {IERC721RegisterOfDeeds} from "./IERC721RegisterOfDeeds.sol";
...
interface IERC721DeedToken {
    ...
    /**
     * Gets the trusted agent for which this contract is registered.
     * @return the trusted agent for which this contract is registered.
     */
    function trustedAgent() external view returns (IERC721TrustedAgent);

    /**
     * Mints a deed for an owner.
